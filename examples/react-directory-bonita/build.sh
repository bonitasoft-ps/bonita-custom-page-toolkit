#!/usr/bin/env bash
# build.sh — install + build + docs helper for the Bonita custom page
#
# Usage:
...
print_outputs() {
  echo
  echo "Output:"
  ls -lh dist/page-appDirectoryBonitaReactHome.zip 2>/dev/null && echo "  └─ upload this ZIP to Bonita resource-list"
