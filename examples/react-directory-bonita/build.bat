@echo off
rem build.bat — install + build + docs helper for the Bonita custom page
rem
rem Usage:
...
echo.
echo Output:
if exist "dist\page-appDirectoryBonitaReactHome.zip" echo   %CD%\dist\page-appDirectoryBonitaReactHome.zip   ^(upload this ZIP to Bonita resource-list^)
