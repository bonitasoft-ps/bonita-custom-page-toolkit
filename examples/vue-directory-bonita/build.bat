@echo off
rem build.bat — install + build + docs helper for the Bonita custom page (Vue 3)
rem
rem Usage:
...
echo.
echo Output:
if exist "dist\page-appDirectoryBonitaVueHome.zip" echo   %CD%\dist\page-appDirectoryBonitaVueHome.zip   ^(upload this ZIP to Bonita resource-list^)
