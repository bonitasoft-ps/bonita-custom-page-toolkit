@echo off
rem build.bat — install + build + docs helper for the Bonita custom page (Svelte 5)
rem
rem Usage:
...
echo.
echo Output:
if exist "dist\page-appDirectoryBonitaSvelteHome.zip" echo   %CD%\dist\page-appDirectoryBonitaSvelteHome.zip   ^(upload this ZIP to Bonita resource-list^)
