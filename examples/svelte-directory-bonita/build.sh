#!/usr/bin/env bash
# build.sh — install + build + docs helper for the Bonita custom page (Svelte 5)
#
# Usage:
...
print_outputs() {
  echo
  echo "Output:"
  ls -lh dist/page-appDirectoryBonitaSvelteHome.zip 2>/dev/null && echo "  └─ upload this ZIP to Bonita resource-list"
