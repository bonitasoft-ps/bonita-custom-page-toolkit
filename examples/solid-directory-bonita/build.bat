@echo off
rem build.bat — install + build + docs helper for the Bonita custom page (SolidJS)
rem
rem Usage:
...
echo.
echo Output:
if exist "dist\page-appDirectoryBonitaSolidHome.zip" echo   %CD%\dist\page-appDirectoryBonitaSolidHome.zip   ^(upload this ZIP to Bonita resource-list^)
