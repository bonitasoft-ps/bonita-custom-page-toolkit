@echo off
rem build.bat — install + build + docs helper for the Bonita custom page (Angular)
rem
rem Usage:
...
echo.
echo Output:
if exist "dist\page-appDirectoryBonitaAngularHome.zip" echo   %CD%\dist\page-appDirectoryBonitaAngularHome.zip   ^(upload this ZIP to Bonita resource-list^)
