...
const DIST_DIR = process.env.DIST_DIR || 'dist/angular-directory-bonita/browser';
const OUTPUT_FILE = process.env.OUTPUT_FILE || 'dist/page-appDirectoryBonitaAngularHome.zip';
